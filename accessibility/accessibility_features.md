...
# {{site.data.keyword.cloud_notm}} accessibility features and support
{: #accessibility-platform}

Learn about {{site.data.keyword.cloud}} accessibility features, including keyboard navigation, screen reader support, and assistive technology compatibility for users with disabilities.
{: shortdesc}
