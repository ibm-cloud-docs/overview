...
Individual services might have other policy information on the lifecycle of their service. Ensure that you review the documentation for each individual service for other details. If a service doesn't document additional policy information, the service follows the policy that is outlined in the [IBM Terms Service Description document](https://www.ibm.com/support/customer/csol/terms/?id=i126-6605&lc=en){: external}.

## Customer notifications throughout the life of a service
{: #communications-lp}

IBM Cloud is committed to providing announcements for upcoming changes that affect IBM Cloud platform and services. To stay updated on lifecycle changes and service updates, you can use any of the following tools:

- If you're looking for IBM Cloud status, platform announcements, security bulletins, or maintenance notifications, see [IBM Cloud status](https://cloud.ibm.com/status/).
