...
# {{site.data.keyword.cloud_notm}} pricing updates and adjustments
{: #price-adjustments}

Review the 2024 and 2025 {{site.data.keyword.cloud}} price changes and adjustments for services, including effective dates and pricing updates for microsoft operating system licenses and infrastructure services.
{: shortdesc}
...
| Virtual Private Cloud | Bare Metal | Standard | vCPU Hour | $0.0035 | $0.0037 |
