...
Deploy {{site.data.keyword.cloud_notm}} services across multizone regions (MZRs), single-campus MZRs, and data centers worldwide. Choose locations nearest your customers for low latency. Review service availability tables for 200+ products across Americas, Europe, and Asia Pacific regions.
{: shortdesc}
