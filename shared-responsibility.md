...
# Understanding shared responsibilities for {{site.data.keyword.cloud_notm}} products and services
{: #shared-responsibilities}

Learn about the shared responsibilities between IBM and customers for managing {{site.data.keyword.cloud}} products, including operations, security, compliance, and disaster recovery tasks.
{: shortdesc}
